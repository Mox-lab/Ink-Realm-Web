    ...
    <section className="mt-6 rounded border border-cyan-400/15 bg-black/30 p-5">
      ...
      <form onSubmit={handleInvite} className="mb-4 flex flex-wrap items-center gap-2">
        <input
          ...
          className="min-w-[140px] flex-1 rounded border border-white/15 bg-black/40 px-3 py-2 text-sm text-white placeholder-white/30 focus:border-cyan-400/50 focus:outline-none"
        />
        <select
          value={role}
          onChange={(e) => setRole(e.target.value)}
          className="rounded border border-white/15 bg-black/40 px-3 py-2 text-sm text-white focus:border-cyan-400/50 focus:outline-none"
        >
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="rounded border border-white/15 bg-black/40 px-2 py-1 text-xs text-white focus:border-cyan-400/50 focus:outline-none"
                >
                  <option value="editor">{t('novel.collaborator.role.editor')}</option>
                  <option value="viewer">{t('novel.collaborator.role.viewer')}</option>
                </select>
